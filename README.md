...
## Overview
This is for a project that examines security and defenses for an agentic system. We want to identify attack surfaces and vectors - we will collect metrics. There will be a target application (PharmaHelp), as well as an attack service (PharmaAttack). PharmaAttack that will attempt to attack PharmaHelp.
